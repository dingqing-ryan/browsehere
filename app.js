(() => {
  ...
  const uiCopy = {
    en:{regionLabel:'REGION',subtitle:'Streaming Website Guide Hub',countryNote:'Recommendations for {country}',eyebrow:'LOCAL STREAMING GUIDE',remoteHint:'Use ▲ ▼ ◀ ▶ to navigate',status:'{count} services available',footer:'Streaming Website Guide Hub Design by ❤️'},
    zh:{regionLabel:'当前地区',subtitle:'流媒体网站指南中心',countryNote:'正在展示 {country} 的推荐',eyebrow:'本地化流媒体指南',remoteHint:'使用 ▲ ▼ ◀ ▶ 遥控器导航',status:'当前可浏览 {count} 个服务',footer:'流媒体网站指南中心 · 用 ❤️ 设计'},
    ja:{regionLabel:'地域',subtitle:'ストリーミングサイトガイドハブ',countryNote:'{country} 向けのおすすめ',eyebrow:'ローカル・ストリーミングガイド',remoteHint:'▲ ▼ ◀ ▶ で操作',status:'{count} 件のサービスを利用できます',footer:'ストリーミングサイトガイドハブ · ❤️ を込めてデザイン'},
    ko:{regionLabel:'지역',subtitle:'스트리밍 웹사이트 가이드 허브',countryNote:'{country} 맞춤 추천',eyebrow:'현지 스트리밍 가이드',remoteHint:'▲ ▼ ◀ ▶ 로 이동',status:'이용 가능한 서비스 {count}개',footer:'스트리밍 웹사이트 가이드 허브 · ❤️로 디자인'},
    pt:{regionLabel:'REGIÃO',subtitle:'Central de Guias de Sites de Streaming',countryNote:'Recomendações para {country}',eyebrow:'GUIA LOCAL DE STREAMING',remoteHint:'Use ▲ ▼ ◀ ▶ para navegar',status:'{count} serviços disponíveis',footer:'Central de Guias de Sites de Streaming · Design com ❤️'},
    es:{regionLabel:'REGIÓN',subtitle:'Centro de Guías de Sitios de Streaming',countryNote:'Recomendaciones para {country}',eyebrow:'GUÍA LOCAL DE STREAMING',remoteHint:'Usa ▲ ▼ ◀ ▶ para navegar',status:'{count} servicios disponibles',footer:'Centro de Guías de Sitios de Streaming · Diseño con ❤️'},
    fr:{regionLabel:'RÉGION',subtitle:'Hub de guides des sites de streaming',countryNote:'Recommandations pour {country}',eyebrow:'GUIDE LOCAL DU STREAMING',remoteHint:'Utilisez ▲ ▼ ◀ ▶ pour naviguer',status:'{count} services disponibles',footer:'Hub de guides des sites de streaming · Conçu avec ❤️'},
    de:{regionLabel:'REGION',subtitle:'Streaming-Website-Guide-Hub',countryNote:'Empfehlungen für {country}',eyebrow:'LOKALER STREAMING-GUIDE',remoteHint:'Mit ▲ ▼ ◀ ▶ navigieren',status:'{count} Dienste verfügbar',footer:'Streaming-Website-Guide-Hub · Mit ❤️ gestaltet'},
    it:{regionLabel:'REGIONE',subtitle:'Hub guida ai siti di streaming',countryNote:'Consigli per {country}',eyebrow:'GUIDA LOCALE ALLO STREAMING',remoteHint:'Usa ▲ ▼ ◀ ▶ per navigare',status:'{count} servizi disponibili',footer:'Hub guida ai siti di streaming · Realizzato con ❤️'},
    ru:{regionLabel:'РЕГИОН',subtitle:'Центр гидов по стриминговым сайтам',countryNote:'Рекомендации для {country}',eyebrow:'МЕСТНЫЙ ГИД ПО СТРИМИНГУ',remoteHint:'Используйте ▲ ▼ ◀ ▶ для навигации',status:'Доступно сервисов: {count}',footer:'Центр гидов по стриминговым сайтам · Создано с ❤️'},
    ar:{regionLabel:'المنطقة',subtitle:'مركز دليل مواقع البث',countryNote:'توصيات لـ {country}',eyebrow:'دليل البث المحلي',remoteHint:'استخدم ▲ ▼ ◀ ▶ للتنقل',status:'{count} خدمة متاحة',footer:'مركز دليل مواقع البث · صُمم بـ ❤️'},
    hi:{regionLabel:'क्षेत्र',subtitle:'स्ट्रीमिंग वेबसाइट गाइड हब',countryNote:'{country} के लिए सुझाव',eyebrow:'स्थानीय स्ट्रीमिंग गाइड',remoteHint:'नेविगेट करने के लिए ▲ ▼ ◀ ▶ दबाएँ',status:'{count} सेवाएँ उपलब्ध हैं',footer:'स्ट्रीमिंग वेबसाइट गाइड हब · ❤️ के साथ डिज़ाइन किया गया'},
    th:{regionLabel:'ภูมิภาค',subtitle:'ศูนย์คู่มือเว็บไซต์สตรีมมิง',countryNote:'คำแนะนำสำหรับ {country}',eyebrow:'คู่มือสตรีมมิงท้องถิ่น',remoteHint:'ใช้ ▲ ▼ ◀ ▶ เพื่อนำทาง',status:'มีบริการ {count} รายการ',footer:'ศูนย์คู่มือเว็บไซต์สตรีมมิง · ออกแบบด้วย ❤️'},
    tr:{regionLabel:'BÖLGE',subtitle:'Yayın Web Sitesi Rehberi Merkezi',countryNote:'{country} için öneriler',eyebrow:'YEREL YAYIN REHBERİ',remoteHint:'Gezinmek için ▲ ▼ ◀ ▶ kullanın',status:'{count} hizmet mevcut',footer:'Yayın Web Sitesi Rehberi Merkezi · ❤️ ile tasarlandı'},
    vi:{regionLabel:'KHU VỰC',subtitle:'Trung tâm hướng dẫn trang web phát trực tuyến',countryNote:'Gợi ý cho {country}',eyebrow:'CẨM NANG PHÁT TRỰC TUYẾN ĐỊA PHƯƠNG',remoteHint:'Dùng ▲ ▼ ◀ ▶ để điều hướng',status:'Có {count} dịch vụ',footer:'Trung tâm hướng dẫn trang web phát trực tuyến · Thiết kế với ❤️'},
    id:{regionLabel:'WILAYAH',subtitle:'Pusat Panduan Situs Streaming',countryNote:'Rekomendasi untuk {country}',eyebrow:'PANDUAN STREAMING LOKAL',remoteHint:'Gunakan ▲ ▼ ◀ ▶ untuk menavigasi',status:'{count} layanan tersedia',footer:'Pusat Panduan Situs Streaming · Dirancang dengan ❤️'},
    nl:{regionLabel:'REGIO',subtitle:'Streamingwebsite-gidshub',countryNote:'Aanbevelingen voor {country}',eyebrow:'LOKALE STREAMINGGIDS',remoteHint:'Gebruik ▲ ▼ ◀ ▶ om te navigeren',status:'{count} diensten beschikbaar',footer:'Streamingwebsite-gidshub · Ontworpen met ❤️'},
    pl:{regionLabel:'REGION',subtitle:'Centrum przewodników po serwisach streamingowych',countryNote:'Polecane dla: {country}',eyebrow:'LOKALNY PRZEWODNIK STREAMINGOWY',remoteHint:'Użyj ▲ ▼ ◀ ▶, aby nawigować',status:'Dostępnych usług: {count}',footer:'Centrum przewodników po serwisach streamingowych · Zaprojektowane z ❤️'},
    uk:{regionLabel:'РЕГІОН',subtitle:'Центр гідів зі стримінгових сайтів',countryNote:'Рекомендації для {country}',eyebrow:'МІСЦЕВИЙ ГІД ЗІ СТРІМІНГУ',remoteHint:'Використовуйте ▲ ▼ ◀ ▶ для навігації',status:'Доступно сервісів: {count}',footer:'Центр гідів зі стримінгових сайтів · Створено з ❤️'},
    fa:{regionLabel:'منطقه',subtitle:'مرکز راهنمای وب‌سایت‌های پخش',countryNote:'پیشنهادها برای {country}',eyebrow:'راهنمای پخش محلی',remoteHint:'برای پیمایش از ▲ ▼ ◀ ▶ استفاده کنید',status:'{count} سرویس در دسترس است',footer:'مرکز راهنمای وب‌سایت‌های پخش · طراحی‌شده با ❤️'},
    he:{regionLabel:'אזור',subtitle:'מרכז מדריכי אתרי סטרימינג',countryNote:'המלצות עבור {country}',eyebrow:'מדריך סטרימינג מקומי',remoteHint:'השתמשו ב־▲ ▼ ◀ ▶ לניווט',status:'{count} שירותים זמינים',footer:'מרכז מדריכי אתרי סטרימינג · עוצב עם ❤️'},
    ms:{regionLabel:'WILAYAH',subtitle:'Hab Panduan Laman Web Penstriman',countryNote:'Cadangan untuk {country}',eyebrow:'PANDUAN PENSTRIMAN TEMPATAN',remoteHint:'Gunakan ▲ ▼ ◀ ▶ untuk navigasi',status:'{count} perkhidmatan tersedia',footer:'Hab Panduan Laman Web Penstriman · Direka dengan ❤️'},
    sw:{regionLabel:'ENEO',subtitle:'Kitovu cha Mwongozo wa Tovuti za Utiririshaji',countryNote:'Mapendekezo kwa {country}',eyebrow:'MWONGOZO WA UTIRIRISHAJI WA ENEO HUSIKA',remoteHint:'Tumia ▲ ▼ ◀ ▶ kuvinjari',status:'Huduma {count} zinapatikana',footer:'Kitovu cha Mwongozo wa Tovuti za Utiririshaji · Imeundwa kwa ❤️'}
  };
  const categoryCopy = {
